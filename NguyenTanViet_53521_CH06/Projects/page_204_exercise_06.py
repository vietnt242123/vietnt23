...
Date: 24/010/2021
Program: page_204_project_06.py
...
Solution:
Enter a number: 4
The total number of files is 1103
E:\LẬP TRÌNH PYTHON\learning python in book
...
8 Quit the program
Enter a number: 7
File in E:\LẬP TRÌNH PYTHON\learning python in book:
NguyenTanVIET_53521_CH07.zip
Enter a file name from these names: text6
Sorry, there is an error in your file name.
...
def viewFile(dirName):
    """
    :param dirName: enter a name
    :return: display the file
    """
